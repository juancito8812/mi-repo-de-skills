...
- **"The user redirected me but I'm still iterating on the old fix"** → STOP. Respect user direction changes. Do not keep re-applying the same fix family after the user says "nada sigue igual" or asks to change enfoque. Return to Phase 1 with the new goal.
